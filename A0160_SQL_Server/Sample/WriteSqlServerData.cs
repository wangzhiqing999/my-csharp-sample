...
namespace A0160_SQL_Server.Sample
{
    ...
    /// <summary>
    /// 用于 写入 SQL Server 数据库的例子.
    /// 
    /// 注意：这个例子所使用的 表 和 数据， 请参考项目下的 Schema.sql 文件。
    /// 
    /// </summary>
    class WriteSqlServerData
    {
...
WHERE 
  ...
  AND sale_item = @sale_item";
        ...
        private void InsertData(SqlConnection conn)
        {
            ...
            // 定义要查询的参数.
            insertCommand.Parameters.Add(new SqlParameter("@sale_date", TEST_SALE_DATE));
            insertCommand.Parameters.Add(new SqlParameter("@sale_item", TEST_SALE_ITEM));
            insertCommand.Parameters.Add(new SqlParameter("@sale_money", 100000));
        ...
        private void ShowData(SqlConnection conn)
        {
            ...
            // 定义要查询的参数.
            selectCommand.Parameters.Add(new SqlParameter("@sale_date", TEST_SALE_DATE));
            selectCommand.Parameters.Add(new SqlParameter("@sale_item", TEST_SALE_ITEM));
        ...
        /// </summary>
        /// <param name="conn"></param>
        private void UpdateData(SqlConnection conn)
        {
            // 创建一个 Command.
            ...
            // 定义要查询的参数.
            updateCommand.Parameters.Add(new SqlParameter("@sale_date", TEST_SALE_DATE));
            updateCommand.Parameters.Add(new SqlParameter("@sale_item", TEST_SALE_ITEM));
            updateCommand.Parameters.Add(new SqlParameter("@sale_money", 0.1));
        ...
        private void DeleteData(SqlConnection conn)
        {
            ...
            // 定义要查询的参数.
            deleteCommand.Parameters.Add(new SqlParameter("@sale_date", TEST_SALE_DATE));
            deleteCommand.Parameters.Add(new SqlParameter("@sale_item", TEST_SALE_ITEM));
        ...
        /// </summary>
        /// <param name="conn"></param>
        private void InsertData(SqlConnection conn, SqlTransaction t)
        {
            // 创建一个 Command.
            SqlCommand insertCommand = conn.CreateCommand();
