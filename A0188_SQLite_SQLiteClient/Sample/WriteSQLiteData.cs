...
WHERE 
  ...
  AND sale_item = @sale_item";
        ...
        /// <returns></returns>
        private bool ExistData(SQLiteConnection conn)
        {
            // 创建一个 Command.
            SQLiteCommand existCommand = conn.CreateCommand();

            // 定义需要执行的SQL语句.
            existCommand.CommandText = EXIST_SQL;

            // 定义要查询的参数.
            existCommand.Parameters.Add(new SQLiteParameter("@sale_date", TEST_SALE_DATE));
            existCommand.Parameters.Add(new SQLiteParameter("@sale_item", TEST_SALE_ITEM));
        ...
        private void InsertData(SQLiteConnection conn)
        {
            ...
            insertCommand.Parameters.Add(new SQLiteParameter("@sale_date", TEST_SALE_DATE));           
            insertCommand.Parameters.Add(new SQLiteParameter("@sale_item", TEST_SALE_ITEM));
            insertCommand.Parameters.Add(new SQLiteParameter("@sale_money", 100000));
        ...
        /// </summary>
        /// <param name="conn"></param>
        private void ShowData(SQLiteConnection conn)
        {
            // 创建一个 Command.
            ...
            // 定义要查询的参数.
            selectCommand.Parameters.Add(new SQLiteParameter("@sale_date", TEST_SALE_DATE));
            selectCommand.Parameters.Add(new SQLiteParameter("@sale_item", TEST_SALE_ITEM));

            // 执行SQL命令，结果存储到Reader中.
            SQLiteDataReader testReader = selectCommand.ExecuteReader();
        ...
        private void UpdateData(SQLiteConnection conn)
        {
            ...
            // 定义要查询的参数.
            updateCommand.Parameters.Add(new SQLiteParameter("@sale_money", 0.1));

            updateCommand.Parameters.Add(new SQLiteParameter("@sale_date", TEST_SALE_DATE));
            updateCommand.Parameters.Add(new SQLiteParameter("@sale_item", TEST_SALE_ITEM));
        ...
        private void DeleteData(SQLiteConnection conn)
        {
            // 创建一个 Command.
            ...
            // 定义要查询的参数.
            deleteCommand.Parameters.Add(new SQLiteParameter("@sale_date", TEST_SALE_DATE));
            deleteCommand.Parameters.Add(new SQLiteParameter("@sale_item", TEST_SALE_ITEM));
        ...
        /// </summary>
        /// <param name="conn"></param>
        private void Transaction(SQLiteConnection conn)
        {
        ...
        /// </summary>
        /// <param name="conn"></param>
        private void InsertData(SQLiteConnection conn, SQLiteTransaction t)
        {
            // 创建一个 Command.
            SQLiteCommand insertCommand = conn.CreateCommand();
