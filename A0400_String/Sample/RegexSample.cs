...
{1}", source, removeAlt);
        ...
        public void DemoRegexUse10()
        {

            Console.WriteLine("[10]");

            string sourceText = @"1.一层分销: 给 {00000000-0000-0000-0000-0000000000b1} 新增 100 * 10.00 = 1000.00积分.
2.二层分销: 给 {00000000-0000-0000-0000-00000000000a} 新增 100 * 5.00 = 500.00积分.";
            ...
            for (int i = 0; i < userIDList.Count; i++)
            {
                ...
                string userName = $"用户_{i + 1}";

                sourceText = sourceText.Replace(userID, userName);
            }
            ...
            sourceText = @"1.一层分销: 给 [00000000-0000-0000-0000-0000000000b1] 新增 100 * 10.00 = 1000.00积分.
2.二层分销: 给 [00000000-0000-0000-0000-00000000000a] 新增 100 * 5.00 = 500.00积分.";
