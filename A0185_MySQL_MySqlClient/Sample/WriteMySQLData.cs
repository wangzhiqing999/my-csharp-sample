...
WHERE 
  ...
  AND sale_item = ?sale_item";
        ...
        /// <returns></returns>
        private bool ExistData(MySqlConnection conn)
        {
            // 创建一个 Command.
            ...
            // 定义要查询的参数.
            existCommand.Parameters.Add(new MySqlParameter("?sale_date", TEST_SALE_DATE));
            existCommand.Parameters.Add(new MySqlParameter("?sale_item", TEST_SALE_ITEM));
        ...
        /// </summary>
        /// <param name="conn"></param>
        private void ShowData(MySqlConnection conn)
        {
            // 创建一个 Command.
            ...
            // 定义要查询的参数.
            selectCommand.Parameters.Add(new MySqlParameter("?sale_date", TEST_SALE_DATE));
            selectCommand.Parameters.Add(new MySqlParameter("?sale_item", TEST_SALE_ITEM));

            // 执行SQL命令，结果存储到Reader中.
            MySqlDataReader testReader = selectCommand.ExecuteReader();
        ...
        private void UpdateData(MySqlConnection conn)
        {
            ...
            // 定义要查询的参数.
            updateCommand.Parameters.Add(new MySqlParameter("?sale_money", 0.1));

            updateCommand.Parameters.Add(new MySqlParameter("?sale_date", TEST_SALE_DATE));
            updateCommand.Parameters.Add(new MySqlParameter("?sale_item", TEST_SALE_ITEM));
        ...
        private void DeleteData(MySqlConnection conn)
        {
            ...
            // 定义要查询的参数.
            deleteCommand.Parameters.Add(new MySqlParameter("?sale_date", TEST_SALE_DATE));
            deleteCommand.Parameters.Add(new MySqlParameter("?sale_item", TEST_SALE_ITEM));
        ...
        /// </summary>
        /// <param name="conn"></param>
        private void Transaction(MySqlConnection conn)
        {
        ...
        /// </summary>
        /// <param name="conn"></param>
        private void InsertData(MySqlConnection conn, MySqlTransaction t)
        {
            // 创建一个 Command.
            MySqlCommand insertCommand = conn.CreateCommand();
