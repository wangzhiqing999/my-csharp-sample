...
namespace A0171_Oracle_ODAC.Sample
{
    ...
    class CallOracleFuncProc
    {
        ...
        private void CallProcedure(OracleConnection conn)
        {
            ...
            // 第2个参数，是输出的.
            OracleParameter para2 = new OracleParameter("p_out_val", OracleDbType.Varchar2, 10);
            para2.Direction = ParameterDirection.Output;
            testCommand.Parameters.Add(para2);

            // 第3个参数，是既输入又输出的.
            OracleParameter para3 = new OracleParameter("p_inout_val", OracleDbType.Varchar2, 20);
