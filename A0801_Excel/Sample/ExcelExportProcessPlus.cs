...
namespace A0801_Excel.Sample
{
    ...
    public class ExcelExportProcessPlus<T1, T2> 
        where T2 : ExcelExportAble
        where T1 : ExcelExportAblePlus<T2>
              
    {
        /// <summary>
        /// 基准的定义得对象.
        /// </summary>
        public T1 BaseDefineObject { set; get; }
            ...
            try
            {
                ...
                foreach (T2 oneData in dataList)
                {
                    ...
                    OleDbParameter[] parameters =
                        BaseDefineObject.GetInsertParameter(oneData);
