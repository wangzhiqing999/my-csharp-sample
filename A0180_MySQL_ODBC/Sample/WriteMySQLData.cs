...
WHERE 
  ...
  AND sale_item = ?";
        ...
        /// <returns></returns>
        private bool ExistData(OdbcConnection conn)
        {
            // 创建一个 Command.
            OdbcCommand existCommand = conn.CreateCommand();

            // 定义需要执行的SQL语句.
            existCommand.CommandText = EXIST_SQL;

            // 定义要查询的参数.
            existCommand.Parameters.Add(new OdbcParameter("@sale_date", TEST_SALE_DATE));
            existCommand.Parameters.Add(new OdbcParameter("@sale_item", TEST_SALE_ITEM));
        ...
        /// </summary>
        /// <param name="conn"></param>
        private void InsertData(OdbcConnection conn)
        {
            // 创建一个 Command.
        ...
        /// </summary>
        /// <param name="conn"></param>
        private void ShowData(OdbcConnection conn)
        {
            // 创建一个 Command.
            OdbcCommand selectCommand = conn.CreateCommand();

            // 定义需要执行的SQL语句.
            selectCommand.CommandText = SELECT_SQL;

            // 定义要查询的参数.
            selectCommand.Parameters.Add(new OdbcParameter("@sale_date", TEST_SALE_DATE));
            selectCommand.Parameters.Add(new OdbcParameter("@sale_item", TEST_SALE_ITEM));

            // 执行SQL命令，结果存储到Reader中.
            OdbcDataReader testReader = selectCommand.ExecuteReader();
        ...
        /// </summary>
        /// <param name="conn"></param>
        private void UpdateData(OdbcConnection conn)
        {
            // 创建一个 Command.
            ...
            // 定义要查询的参数.
            updateCommand.Parameters.Add(new OdbcParameter("@sale_money", 0.1));

            updateCommand.Parameters.Add(new OdbcParameter("@sale_date", TEST_SALE_DATE));
            updateCommand.Parameters.Add(new OdbcParameter("@sale_item", TEST_SALE_ITEM));
        ...
        private void DeleteData(OdbcConnection conn)
        {
            // 创建一个 Command.
            OdbcCommand deleteCommand = conn.CreateCommand();

            // 定义需要执行的SQL语句.
            deleteCommand.CommandText = DELETE_SQL;

            // 定义要查询的参数.
            deleteCommand.Parameters.Add(new OdbcParameter("@sale_date", TEST_SALE_DATE));
            deleteCommand.Parameters.Add(new OdbcParameter("@sale_item", TEST_SALE_ITEM));
