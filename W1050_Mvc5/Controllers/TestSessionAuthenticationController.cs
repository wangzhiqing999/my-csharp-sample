...
{
    public class TestSessionAuthenticationController : Controller
    {
        ...
        public TestSessionAuthenticationController()
        {
            this._AuthenticationProcesser = new SessionAuthenticationProcesser();
        }

        // GET: TestSessionAuthentication
