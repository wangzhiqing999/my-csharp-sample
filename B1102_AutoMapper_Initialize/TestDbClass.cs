...
namespace B1100_AutoMapper.Model
{
    ...
    public class TestDbClass
    {
        ...
        {
            return String.Format("TestDbClass : [ID = {0}; Name = {1}; Status = {2}; CreateUser = {3}; CreateTime = {4}; LastUpdateUser = {5}; LastUpdateTime = {6} ]",
                    ID, Name, Status, CreateUser, CreateTime, LastUpdateUser, LastUpdateTime);
        }
